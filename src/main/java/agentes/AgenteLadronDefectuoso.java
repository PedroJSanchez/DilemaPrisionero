...
import static util.Constantes.DECISION;
 ...
 * @author pedroj
 */
public class AgenteLadronDefectuoso extends Agent {
    ...
    //private Map<String, Integer> partidasPolicia;
    ...
    protected void setup() {
        ...
        //partidasPolicia = new HashMap();
        
        // Regisro de la Ontología
        try {
            ontology = OntologiaDilemaPrisionero.getInstance();
        } catch (BeanOntologyException ex) {
            Logger.getLogger(AgenteLadronDefectuoso.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void definirMiJugador() {
        jugador = new Jugador("pedroj-" + getAID().getLocalName() , getAID());
    }
    
    private void analizarResultadoJugada( ResultadoJugada resultado) {
...
//                PartidaAceptada partidaAceptada = new PartidaAceptada();
...
//            movimiento.setJugador(null);
//            JugadaEntregada movimiento = new JugadaEntregada();
...
//                System.out.println(accept);
            ...
            analizarResultadoJugada(resultado);
